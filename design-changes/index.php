...
<head>
	...
	<script src="login-assets/js/cufon-yui.js" type="text/javascript"></script>
	<script src="login-assets/js/helvetica-neue-medium_500.font.js" type="text/javascript"></script>
	<script type="text/javascript">
			Cufon.replace('h1'); // Works without a selector engine
	</script>
	<link rel="stylesheet" type="text/css" href="login-assets/login-css/login-styles.css" />
	<link rel="stylesheet" type="text/css" href="login-assets/login-css/styles.css" />
			...
			<form action="./" method="post" autocomplete="off">
			      ...
			      <input type="username" name="username" placeholder="Username or email" id="username">
			        ...
			        <label for="password">Password</label>
			        		<p><a href="mailto:Elena_Pretto@mckinsey.com">Forgot or Need Credentials?</a></p>
...
<div class="login-form">
	...
	<?php
		...
		$credentials = array ("IBMWH", "IBMWH", "IBMWH07", "IBMWH07");
		...
		if (isset($_SESSION['login']) && $_SESSION['login'] == $hash) {
				...
				echo("<script>location.href = 'module7.php';</script>");
				die(); 
		}
